...
const sections = [
  {
    ...
    features: [
      { name: 'Tax Savings', tiers: { Starter: true, Scale: true } },
      { name: 'Easy to use accounting', tiers: { Starter: true, Scale: true } },
      ...
      { name: 'Exclusive offers', tiers: { Starter: false, Scale: true } },
      { name: '6 months free advisor', tiers: { Starter: false, Scale: true } },
      { name: 'Mobile and web access', tiers: { Starter: false, Scale: true } },
    ],
  },
  {
    name: 'Other perks',
    features: [
      { name: '24/7 customer support', tiers: { Starter: true, Scale: true } },
      { name: 'Instant notifications', tiers: { Starter: true, Scale: true } },
      { name: 'Budgeting tools', tiers: { Starter: true, Scale: true } },
      { name: 'Digital receipts', tiers: { Starter: true, Scale: true } },
      { name: 'Pots to separate money', tiers: { Starter: false, Scale: true } },
      { name: 'Free bank transfers', tiers: { Starter: false, Scale: true } },
      { name: 'Business debit card', tiers: { Starter: false, Scale: true } },
    ],
  },
]
